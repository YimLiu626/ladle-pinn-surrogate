...
The CFD-DPM simulation code and surrogate modeling code are available at anonymous repositories. Links and access instructions will be provided upon acceptance. A sample of the 12-column CFD export format (100 rows) is included in the supplementary material.

\bibliographystyle{unsrtnat}
\begin{thebibliography}{99}

\bibitem{liu2026cfd} Anonymous. A cell-localized bucket search method for conservative bubble-inclusion contact screening. \textit{Under review}, 2026.
